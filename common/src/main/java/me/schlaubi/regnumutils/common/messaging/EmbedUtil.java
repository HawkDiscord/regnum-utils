...
import me.schlaubi.regnumutils.common.constants.Colors;
import me.schlaubi.regnumutils.common.constants.Emotes;
...
public class EmbedUtil {
    ...
    public static EmbedBuilder success(@Nullable String title, @Nullable String description) {
        return embed(
                formatTile(title, Emotes.SUCCESS),
                description,
                Colors.DARK_GREEN
        );
    }
     ...
     */
    @NotNull
    public static EmbedBuilder loading(@Nullable String title, @Nullable String description) {
        return embed(
                formatTile(title, Emotes.LOADING),
                description,
                Colors.DARK_BUT_NOT_BLACK
        );
    }
     ...
     */
    @NotNull
    public static EmbedBuilder loading(@Nullable String description) {
        return embed(description, Colors.DARK_BUT_NOT_BLACK);
    }

    private static String formatTile(@Nullable String title, String loading) {
        return String.format("%s %s", loading, title);
    }
